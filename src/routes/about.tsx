  ...
  return (
    <>
        ...
        <div className="grid gap-12 md:grid-cols-[1.2fr_1fr] md:gap-16">
          <div>
            ...
            <div className="mt-6 space-y-5 text-base leading-relaxed text-muted-foreground">
              <p>The Policy Analysis and Research Congress was founded at COOU Igbariam by students who believed the university should be more than a place to earn a degree — it should be a place to form minds.</p>
              ...
              <p>Today, PARC brings together students across disciplines to study policy, interrogate economics, sharpen argument, and prepare for principled public life.</p>
            </div>
          </div>
      ...
      <section className="border-t border-border bg-[color:var(--surface)]">
        <div className="container-parc py-20 md:py-24">
          <SectionHeading eyebrow="Founder Message" title="A word from the founder." />
          <div className="mt-10 grid gap-8 md:grid-cols-[280px_1fr] md:items-start md:gap-12">
            <div className="mx-auto flex aspect-square w-full max-w-[280px] items-center justify-center rounded-2xl border border-border bg-gradient-to-br from-primary/10 to-[color:var(--gold)]/10">
              <User className="h-16 w-16 text-primary/40" />
            </div>
            <blockquote className="font-serif text-2xl leading-snug text-foreground sm:text-3xl">
              <span className="text-primary">"</span>Placeholder for the founder's message. This space is reserved for a statement from the founder of PARC on the vision, purpose and future of the congress.<span className="text-primary">"</span>
              <footer className="mt-6 text-xs uppercase tracking-widest text-muted-foreground">Founder, PARC — placeholder</footer>
            </blockquote>
          </div>
        </div>
      </section>
